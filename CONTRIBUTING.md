...
# Contributing to Appium Mobile Actions for Java
...
[Appium Mobile Actions for Java Code of Conduct](https://github.com/appium-actions/appium-mobile-actions-javablob/master/CODE_OF_CONDUCT.md).
...
existing [Issues](https://github.com/appium-actions/appium-mobile-actions-java/issues) that might help you. In case you
...
- Open an [Issue](https://github.com/appium-actions/appium-mobile-actions-java/issues/new).
...
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there
  ...
  the [bug tracker](https://github.com/appium-actions/appium-mobile-actions-javaissues?q=label%3Abug).
...
- Open an [Issue](https://github.com/appium-actions/appium-mobile-actions-java/issues/new). (Since we can't be sure at
...
- Make sure that you are using the latest version.
- Perform a [search](https://github.com/appium-actions/appium-mobile-actions-java/issues) to see if the enhancement has
...
as [GitHub issues](https://github.com/appium-actions/appium-mobile-actions-java/issues).
...
1. Clone the [Appium Mobile Actions for Java repository](https://github.com/appium-actions/appium-mobile-actions-java)
...
8. Don't forget to update
   the [README.md](https://github.com/appium-actions/appium-mobile-actions-javablob/master/README.md) if necessary.
